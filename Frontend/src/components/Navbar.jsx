...
export default function Navbar() {
  ...
  const CapsuleIcon = ({ item }) => (
    <a href={item.url} title={item.title} className="group flex flex-col items-center gap-1 hover:scale-110 transition-transform duration-200">
    ...
    <nav ref={menuRef} className="bg-brand-terre text-white shadow-md">
      <div className="flex flex-row justify-between items-center px-6 py-3">
        ...
        <div className="hidden md:flex gap-8 font-medium">
          ...
          <a href="/services" className="text-white/80 hover:text-brand-soleil transition">Nos Services</a>
        ...
        {isAuthenticated ? (
          <div className="hidden md:flex gap-3 items-center">
            ...
            <a href="/profil" className="text-white/80 hover:text-brand-soleil transition text-sm font-medium">Mon profil</a>
            <button onClick={logout} className="bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-600 transition">
              Déconnexion
            </button>
          </div>
        ) : (
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-medium text-center hover:bg-red-600 transition"
                >
                  Déconnexion
                </button>
              </>
