...
export default function HebergementCardDetails (nom, type, capacite, description, prix_nuit, image) {
  const amenities = [
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
          ...
          <div className="bg-gray-50 p-4 rounded-xl text-center">
            ...
            <p className="font-semibold">2 chambres</p>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-xl text-center">
            ...
            <p className="font-semibold">35 m²</p>
          </div>
        </div>
